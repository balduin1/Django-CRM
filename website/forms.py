...
class SignUpForm(UserCreationForm):
    ...
    first_name = forms.CharField(label="", max_length=100, widget=forms.CharField(attrs={'class':'form-control', 'placeholder':'First name'}))
    last_name = forms.CharField(label="", max_length=100, widget=forms.CharField(attrs={'class':'form-control', 'placeholder':'Last name'}))
